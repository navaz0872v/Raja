...
bot = telebot.TeleBot('7846007953:AAGsUXrC9A0Y3ppwXBSPeFL_Rr41BcDOSrI')
# Admin user IDs
admin_id = {"1885926472"}
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  
            ...
            if time > 241:
                ...
                response = f"-漫~*'¨¯¨'*·舞~ 🇮🇳𝘼𝙏𝙏𝘼𝘾𝙆 𝘾𝙊𝙈𝙋𝙇𝙀𝙏𝙀🇮🇳 ~舞*'¨¯¨'*·~漫- king: {king} soulking: {soulking} soulking: {time}"
        else:
            response = "✅⚠️ 𝗨𝗦𝗔𝗚𝗘: /attack <𝗜𝗣> <𝗣𝗢𝗥𝗧> <𝗧𝗜𝗠𝗘> 𝗘𝗫𝗔𝗠𝗣𝗟𝗘 /𝗮𝘁𝘁𝗮𝗰𝗸 𝟮𝟬.𝟮𝟯𝟱.𝟵𝟭.𝟭𝟬𝟲 𝟮𝟴𝟬𝟲𝟬 𝟭𝟴𝟬
    else:
        response = " ミ🥹★ 𝗔𝗖𝗖𝗘𝗦𝗦 𝗟𝗘 𝗟𝗘 𝗕𝗥𝗢 𝗠𝗔𝗙𝗜𝗔 𝗞𝗢 𝗗𝗠 𝗞𝗔𝗥 ★🥹彡 - @Mafia_op24 ."
...
def welcome_start(message):
    ...
    response = f'''ıllıllı⭐🌟 𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 𝙼𝙰𝙵𝙸𝙰 𝙵𝙰𝙼𝙸𝙻𝚈 ❣️ 🌟⭐ıllıllı \n {user_name}! \n🄱🄶🄼🄸 🄺🄸 🄶🄰🄽🄳 🄼🄰🅁🄽🄴 🄰🄰 🄶🅈🄴😜
